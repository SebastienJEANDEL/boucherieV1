<main>
        <h2> MAURICE </h2>
         ...
         <!-- Navbar Header type [bovins]: home  types  races disponibilities (tous les détails de tous les bovins)-->
                                           
         
         <!-- affichage de la photo, de la liste des éléments à sélectionner, de la ferme, du carnet vétérinaire-->
