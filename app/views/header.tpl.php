    ...
    <header>
     ...
     <div class="top-bar">
      <div class="container-fluid">
        ...
        <!-- Navbar Header nouveautés promos -->
          ...
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <?php foreach ($categoriesList as $categoryObject): ?>
                    <?php 
                      /* 
                    ...
                    <a class="dropdown-item" href="
                      <?= $router->generate('catalog-category', ['id' => $categoryObject->getId()]) ?>
                    "><?= $categoryObject->getName() ?></a>
                  <?php endforeach; ?>
                </div>
              </div>
            </li>
            <li class="nav-item">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <?php foreach ($typesList as $typeObject): ?>
                    <a class="dropdown-item" 
                      href="<?= $router->generate('catalog-type', ['id' => $typeObject->getId()]) ?>"
                    ><?= $typeObject->getName() ?></a>
                  <?php endforeach; ?>
                </div>
              </div>
            </li>
            <li class="nav-item">
              <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                  <?php foreach ($brandsList as $brandObject): ?>
                    <a class="dropdown-item" href="<?= $router->generate('catalog-brand', ['id' => $brandObject->getId()]) ?>"><?= $brandObject->getName() ?></a>
                  <?php endforeach; ?>
                </div>
              </div>
            </li>
