      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 text-center">
            <p class="mb-md-0"><a class="text-white" href="<?= $router->generate('main-legal-mentions') ?>">Mentions légales</a><br><a class="text-white" href="#">Conditions générales de vente</a></p>
          </div>
