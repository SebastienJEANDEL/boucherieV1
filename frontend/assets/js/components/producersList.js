// Component used for everything related to the list of producers
const producersList = {
    init: function() {
        console.log('producerslist init');
        producersList.loadProducersFromAPI();
    },
    loadProducersFromAPI: function() {
        let fetchOptions = {
            method: 'GET'
        };
        request = fetch(app.apiRootUrl + 'producers', fetchOptions);
        request.then(
            function(response) {
